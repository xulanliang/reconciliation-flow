 ...
 */
@Controller
@RequestMapping("/admin/summaryByPayBusinessType")
public class SummaryByPayBusinessTypeController extends FrameworkController {
	@Autowired
	private SummaryService summaryByPayTypeService;
	@Autowired
	...
	public String main(ModelMap model) {
		...
		return autoView("reports/summaryByPayBusinessType");
	}

	@RestController
	@RequestMapping(value = "/admin/SummaryByPayBusinessType/data")
	class OperationLogDataController extends BaseController {
		...
		public WebUiPage<Map<String, Object>> findList(SummaryService.SummaryByPayTypeVo query) {
			...
			List<Map<String, Object>> resultList = summaryByPayTypeService.findAllOfSummaryByBuisinessType(query);
