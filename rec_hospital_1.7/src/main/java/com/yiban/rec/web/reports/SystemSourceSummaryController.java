...
@Controller
@RequestMapping("")
public class SystemSourceSummaryController {
	@Autowired
	...
	public int otherAcount(Map<String, Object> colMap) {
		int allAcount = Integer.parseInt(String.valueOf(colMap.get("allAcount")==null?"0":colMap.get("allAcount")));
		int registerAcount = Integer.parseInt(String.valueOf(colMap.get("registerAcount")==null?"0":colMap.get("registerAcount")));
		int makeAppointmentAcount = Integer.parseInt(String.valueOf(colMap.get("makeAppointmentAcount")==null?"0":colMap.get("makeAppointmentAcount")));
		int payAcount = Integer.parseInt(String.valueOf(colMap.get("payAcount")==null?"0":colMap.get("payAcount")));
		int clinicAcount = Integer.parseInt(String.valueOf(colMap.get("clinicAcount")==null?"0":colMap.get("clinicAcount")));
		int prepaymentForHospitalizationAcount = Integer
				.parseInt(String.valueOf(colMap.get("prepaymentForHospitalizationAcount")==null?"0":colMap.get("prepaymentForHospitalizationAcount")));
	...
	public BigDecimal otherAmount(Map<String, Object> colMap) {
		BigDecimal allAmount = new BigDecimal(String.valueOf(colMap.get("allAmount")==null?"0.00":colMap.get("allAmount")));
		BigDecimal registerAmount = new BigDecimal(String.valueOf(colMap.get("registerAmount")==null?"0.00":colMap.get("registerAmount")));
		BigDecimal makeAppointmentAmount = new BigDecimal(String.valueOf(colMap.get("makeAppointmentAmount")==null?"0.00":colMap.get("makeAppointmentAmount")));
		BigDecimal payAmount = new BigDecimal(String.valueOf(colMap.get("payAmount")==null?"0.00":colMap.get("payAmount")));
		BigDecimal clinicAmount = new BigDecimal(String.valueOf(colMap.get("clinicAmount")==null?"0.00":colMap.get("clinicAmount")));
		BigDecimal prepaymentForHospitalizationAmount = new BigDecimal(
				String.valueOf(colMap.get("prepaymentForHospitalizationAmount")==null?"0.00":colMap.get("prepaymentForHospitalizationAmount")));
	...
	public void commonExportExcel(String fileName, String workSheetName, HttpServletRequest request,
		...
		String[] titleArray = { "渠道名称", "笔数", "金额(元)", "笔数", "金额(元)", "笔数", "金额(元)", "笔数", "金额(元)", "笔数", "金额(元)",
				"笔数", "金额(元)" };
		...
		if (dataList.size() > 0) {
			...
			for (int i = 0, len = dataList.size(); i < len; i++) {
				...
				cell1.setCellValue(Integer.parseInt(colMap.get("registerAcount")==null?"0":colMap.get("registerAcount").toString()));
				...
				cell3.setCellValue(Integer.parseInt(colMap.get("makeAppointmentAcount")==null?"0":colMap.get("makeAppointmentAcount").toString()));
				...
				cell5.setCellValue(Integer.parseInt(colMap.get("payAcount")==null?"0":colMap.get("payAcount").toString()));
				...
				cell7.setCellValue(Integer.parseInt(colMap.get("clinicAcount")==null?"0":colMap.get("clinicAcount").toString()));
				...
				cell10.setCellValue(Double.parseDouble(
	 ...
	 */
	@Controller
	@RequestMapping(value = "admin/syssource/unionpay")
	public class UnionSysSourceReportsController extends CurrentUserContoller {
		...
		public String index(ModelMap model) {
			...
			return "reports/syssource/unionPayForSourceReports";
		}
		...
		public WebUiPage<Map<String, Object>> data(ReportSummaryService.SummaryQuery query) {
			...
			query.setColumnSql(" bill_source ");
	 ...
	 */
	@Controller
	@RequestMapping(value = "admin/syssource/wechatpay")
	public class wecharpaySysSourceReportsController extends CurrentUserContoller {
		...
		public String index(ModelMap model) {
			...
			return "reports/syssource/wechatPayForSourceReports";
		}
		...
		public WebUiPage<Map<String, Object>> data(ReportSummaryService.SummaryQuery query) {
			...
			query.setColumnSql(" bill_source ");
			query.setPayType(EnumTypeOfInt.PAY_TYPE_WECHAT.getValue());
			List<Map<String, Object>> res = reportSummaryService.findAllOfSummaryByBusinessType(query);
			return new WebUiPage<>(res.size(), res);
		}
	 ...
	 */
	@Controller
	@RequestMapping(value = "admin/syssource/alipay")
	public class alipaySysSourceReportsController extends CurrentUserContoller {
		...
		public String index(ModelMap model) {
			...
			return "reports/syssource/aliPayForSourceReports";
		}
		...
		public WebUiPage<Map<String, Object>> data(ReportSummaryService.SummaryQuery query) {
			...
			query.setColumnSql(" bill_source ");
			query.setPayType(EnumTypeOfInt.PAY_TYPE_ALIPAY.getValue());
			List<Map<String, Object>> res = reportSummaryService.findAllOfSummaryByBusinessType(query);
			return new WebUiPage<>(res.size(), res);
		}
	 ...
	 */
	@Controller
	@RequestMapping(value = "admin/syssource/juhepay")
	public class juhePaySysSourceReportsController extends CurrentUserContoller {
		...
		public String index(ModelMap model) {
			...
			return "reports/syssource/juhePayForSourceReports";
		}
		...
		public WebUiPage<Map<String, Object>> data(ReportSummaryService.SummaryQuery query) {
			...
			query.setColumnSql(" bill_source ");
			query.setPayType(EnumTypeOfInt.PAY_TYPE_AGGREGATE.getValue());
			List<Map<String, Object>> res = reportSummaryService.findAllOfSummaryByBusinessType(query);
			return new WebUiPage<>(res.size(), res);
		}
	 ...
	 */
	@Controller
	@RequestMapping(value = "admin/syssource/cashpay")
	public class cashPaySysSourceReportsController extends CurrentUserContoller {
		...
		public String index(ModelMap model) {
			...
			return "reports/syssource/cashPayForSourceReports";
		}
		...
		public WebUiPage<Map<String, Object>> data(ReportSummaryService.SummaryQuery query) {
			...
			query.setColumnSql(" bill_source ");
			query.setPayType(EnumTypeOfInt.CASH_PAYTYPE.getValue());
			List<Map<String, Object>> res = reportSummaryService.findAllOfSummaryByBusinessType(query);
			return new WebUiPage<>(res.size(), res);
		}
	 ...
	 */
	@Controller
	@RequestMapping(value = "admin/syssource/healthpay")
	public class healthPaySysSourceReportsController extends CurrentUserContoller {
		...
		public String index(ModelMap model) {
			...
			return "reports/syssource/healthPayForSourceReports";
		}
		...
		public WebUiPage<Map<String, Object>> data(ReportSummaryService.SummaryQuery query) {
			...
			query.setColumnSql(" bill_source ");
			query.setPayType(EnumTypeOfInt.PAY_TYPE_HEALTH.getValue());
			List<Map<String, Object>> res = reportSummaryService.findAllOfSummaryByBusinessType(query);
			return new WebUiPage<>(res.size(), res);
		}
