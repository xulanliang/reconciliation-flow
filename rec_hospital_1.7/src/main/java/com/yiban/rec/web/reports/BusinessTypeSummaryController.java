...
@Controller
@RequestMapping("")
public class BusinessTypeSummaryController {
	...
	@Autowired
	private ThirdBillBlbService thirdBillBlbService;
...
//		fontStyle.setFont(font);
		...
		String[] titleArray = { "业务类型", "笔数", "金额(元)", "笔数", "金额(元)", "笔数", "金额(元)", "笔数", "金额(元)", "笔数", "金额(元)", "笔数",
				"金额(元)" };
	 ...
	 */
	@Controller
	@RequestMapping(value = "admin/businesstype/outpatientdept")
	public class outpatientDeptReportsController extends CurrentUserContoller {
		...
		public String index(ModelMap model) {
			...
			return "reports/businesstype/outpatientdeptReports";
		}
		...
		public WebUiPage<Map<String, Object>> data(ReportSummaryService.SummaryQuery query) {
			...
			query.setColumnSql(" Pay_Business_Type ");

			// 门诊类型
			query.setPatType(EnumTypeOfInt.PAT_TYPE_MZ.getValue());
	 ...
	 */
	@Controller
	@RequestMapping(value = "admin/businesstype/hospitalization")
	public class hospitalizationReportsController extends CurrentUserContoller {
		...
		public String index(ModelMap model) {
			...
			return "reports/businesstype/hospitalizationReports";
		}
		...
		public WebUiPage<Map<String, Object>> data(ReportSummaryService.SummaryQuery query) {
			...
			// 住院类型
			query.setPatType(EnumTypeOfInt.PAT_TYPE_ZY.getValue());
			List<Map<String, Object>> res = reportSummaryService.findAllOfSummaryByPayType(query);
			return new WebUiPage<>(res.size(), res);
		}
	 ...
	 */
	@Controller
	@RequestMapping(value = "admin/businesstype/blb")
	public class blbReportsController extends CurrentUserContoller {
		...
		public String index(ModelMap model) {
			...
			return "reports/businesstype/blb";
		}
		...
		public WebUiPage<Map<String, Object>> data(ReportSummaryService.SummaryQuery query) {
			...
			query.setColumnSql(" Pay_Business_Type ");
			// 病历本账单都是渠道账单，所以从复制表 third_bill_blb 汇总数据
			List<Map<String, Object>> res = thirdBillBlbService.findAllOfSummaryByPayType(query);
			return new WebUiPage<>(res.size(), res);
		}
