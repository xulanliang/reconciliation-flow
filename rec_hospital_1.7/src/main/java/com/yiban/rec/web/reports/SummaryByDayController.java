 ...
 */
@Controller
@RequestMapping("/admin/summaryByDay")
public class SummaryByDayController extends FrameworkController {
	...
	public String main(ModelMap model) {
		...
		return autoView("reports/summaryByDay");
	}

	@RestController
	@RequestMapping(value = "/admin/summaryByDay/data")
	class OperationLogDataController extends BaseController {
		...
		public WebUiPage<Map<String, Object>> findList(SummaryService.SummaryByPayTypeVo query) {
			...
			List<Map<String, Object>> resultList = summaryService.findAllOfSummaryByDay(query);
