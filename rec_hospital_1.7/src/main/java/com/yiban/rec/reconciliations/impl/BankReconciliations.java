 ...
 * @Date 2018年7月19日
 */
public class BankReconciliations extends AbstractThirdBillReconciliations {

    public BankReconciliations(String orgCode, String date) {
        super(orgCode, date);
    }

    @Override
    protected List<ThirdBill> sourceList() {
        return super.sourceList(EnumTypeOfInt.PAY_TYPE_BANK.getValue());
    }

    @Override
    protected List<HisTransactionFlow> targetList() {
        return super.targetList(EnumTypeOfInt.PAY_TYPE_BANK.getValue());
    }
}
