	...
	function collect(orgNo){
		...
		$.ajax({
	           ...
	           success:function(result){
					...
					//定制需求
					$("#jdwechatAllAmount").html(new Number(formatNum(result.data.jdwechatAllAmount)).toFixed(2));
					$("#jdwechatAllNum").html(result.data.jdwechatAllNum);
					$("#ccbAllAmount").html(new Number(formatNum(result.data.ccbAllAmount)).toFixed(2));
					$("#ccbAllNum").html(result.data.ccbAllNum);
					$("#pfAllAmount").html(new Number(formatNum(result.data.pfAllAmount)).toFixed(2));
					$("#pfAllNum").html(result.data.pfAllNum);
					$("#jhAllAmount").html(new Number(formatNum(result.data.jhAllAmount)).toFixed(2));
					$("#jhAllNum").html(result.data.jhAllNum);
	           }
	       });
	}
