...
public class ThirdBill extends IdEntity {
...
//	private String businessFlowNo;
	...
	public Date getBankfileTime() {
		return bankfileTime;
	}

	public void setBankfileTime(Date bankfileTime) {
		this.bankfileTime = bankfileTime;
	}

	@Override
	public String toString() {
		return "ThirdBill [orgNo=" + orgNo + ", orgName=" + orgName + ", paySource=" + paySource + ", payType="
				+ payType + ", recPayType=" + recPayType + ", payTypeName=" + payTypeName + ", payShopNo=" + payShopNo
				+ ", paySourceName=" + paySourceName + ", custName=" + custName + ", patientCardNo=" + patientCardNo
				+ ", cardType=" + cardType + ", custIdentifyType=" + custIdentifyType + ", visitNumbe=" + visitNumbe
				+ ", payTermNo=" + payTermNo + ", payBatchNo=" + payBatchNo + ", payFlowNo=" + payFlowNo
				+ ", payAccount=" + payAccount + ", payAmount=" + payAmount + ", tradeDatatime=" + tradeDatatime
				+ ", authoriCode=" + authoriCode + ", orderState=" + orderState + ", orderStateName=" + orderStateName
				+ ", oriPayFlowNo=" + oriPayFlowNo + ", updatedBy=" + updatedBy + ", updatedTime=" + updatedTime
				+ ", createdDate=" + createdDate + ", isDeleted=" + isDeleted + ", isActived=" + isActived
				+ ", PayBusinessType=" + PayBusinessType + ", refundState=" + refundState + ", shopFlowNo=" + shopFlowNo
				+ ", billSource=" + billSource + ", orderNo=" + orderNo + ", outTradeNo=" + outTradeNo + ", fileId="
				+ fileId + ", patType=" + patType + ", invoiceNo=" + invoiceNo + ", referenceNum=" + referenceNum
				+ ", requireRefund=" + requireRefund + ", unionPayType=" + unionPayType + ", unionPayCode="
				+ unionPayCode + ", unionSystemCode=" + unionSystemCode + ", bankfileTime=" + bankfileTime + "]";
	}
}
