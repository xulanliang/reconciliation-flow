 ...
 */
@Entity
@Table(name = "t_healthcare_official")
public class HealthCareOfficial extends IdEntity {
	...
	public String toString() {
		return "HealthCareOfficial{" +
				...
				", costCash=" + costCash +
				", costWhole=" + costWhole +
				", costRescue=" + costRescue +
				", costSubsidy=" + costSubsidy +
				", costTotalInsurance=" + costTotalInsurance +
				", billSource='" + billSource + '\'' +
				", orderState='" + orderState + '\'' +
				", patientName='" + patientName + '\'' +
				", patType='" + patType + '\'' +
				", shopFlowNo='" + shopFlowNo + '\'' +
				'}';
	}
