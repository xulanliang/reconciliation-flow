...
public class IntervalUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(IntervalUtil.isInTheInterval("11", "[9,11)"));
        System.out.println(IntervalUtil.isInTheInterval("42080936", "[42080922,42080934]"));
        System.out.println(IntervalUtil.isInTheInterval("0.1", ">50%"));
    }
}
